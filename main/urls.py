...
urlpatterns = [
    ...
    path('admin/student-management/delete/<int:id_student>', admin_views.admin_student_delete,name='admin_student_delete'),
    path('admin/student-management/edit/<int:id_student>', admin_views.admin_student_edit, name='admin_student_edit'),
    path('admin/student-management/get-info/<int:id_student>', admin_views.admin_student_get_info, name='admin_student_get_info'),
    ...
    path('admin/schedule-management/delete/<int:id_classroom>', admin_views.admin_schedule_delete, name='admin_schedule_delete'),
    path('admin/schedule-management/edit/<int:id_classroom>', admin_views.admin_schedule_edit, name='admin_schedule_edit'),
    path('admin/schedule-management/get-info/<int:id_classroom>', admin_views.admin_schedule_get_info, name='admin_schedule_get_info'),
